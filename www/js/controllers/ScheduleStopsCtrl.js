angular.module('starter.controllers').controller("ScheduleStopsCtrl", function ($scope, $state, $ionicLoading, routeService, stopService, shareService, favouritesService)
{
	$scope.gotoMap = function()
	{
	 $state.go('app.scheduleMap');
	}
