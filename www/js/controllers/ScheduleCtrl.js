angular.module('starter.controllers').controller('ScheduleCtrl', function ($scope, $state, $ionicLoading, $ionicHistory, routeService, shareService, favouritesService, $ionicPopup)
{
  $scope.routes = [];
  ...
  promise.then(function (data1)
  {
    ...
    $scope.setRoute = function (route)
    {
      ...
      mixpanel.track("Schedule", {"Schedule Id":$scope.routeID});
